...
<details>
<summary>typical tech stack</summary>

- Languages: C#, C++
- UI: WPF, MAUI, light HTML/CSS
- Datastores: SQL Server
- Learning: React, Azure
- Other: unit testing, event messaging
...
- Experience: 10+ years .NET engineering across various industries.  
- Current role: Senior Consultant at a tax & audit professional services firm.  
- Core strengths: C#, .NET 8+, WPF/MAUI, Entity Framework Core, desktop architecture and design patterns.  
- Background highlight: early C++ game development → long career shipping .NET desktop apps and tooling.  
- Typical contributions: feature design, refactors that reduce tech debt, performant database patterns, pragmatic test coverage.  
- Delivery style: iterative shipping via idempotent PRs.  
- Looking for: interesting side projects, tooling challenges, and TTRPG-adjacent hacks.
...
- [ffxiv-teamcraft](https://github.com/ffxiv-teamcraft/ffxiv-teamcraft) — a community-built companion app for Final Fantasy XIV that brings crafting, tracking, and convenience to players.  
- [foundryvtt/pf2e](https://github.com/foundryvtt/pf2e) — the Pathfinder 2e system for Foundry Virtual Tabletop; excellent reference for integrating complex RPG rules into tooling.
